...
import { Sunrise, Sun, Moon, Clock, Calendar as CalendarIcon } from 'lucide-react';
...
const ShiftCardView: React.FC<ShiftCardViewProps> = ({ shifts, isLoading, onSelectShift }) => {
